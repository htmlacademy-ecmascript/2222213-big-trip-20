...
export default class PointPresenter {
  ...
  init(point) {
    ...
    if(this.#mode === Mode.EDITING) {
      replace(this.#pointsComponent, prevPointEditComponent);
  ...
  setSaving() {
    if (this.#mode === Mode.EDITING) {
      this.#editPointsComponent.updateElement({
        isDisabled: true,
        isSaving: true,
      });
    }
  ...
  setAborting() {
    ...
    this.#editPointsComponent.shake(resetFormState);
  }
