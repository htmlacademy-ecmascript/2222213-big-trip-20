  ...
  return /*html*/ `
    <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        ...
        value="sort-event" data-sort-type="event" disabled>
        <label class="trip-sort__btn" for="sort-event">Event</label>
      </div>

      <div class="trip-sort__item  trip-sort__item--time">
        <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort"
        value="sort-time" ${currentSortType === SortType.TIME ? 'checked' : ''} data-sort-type=${SortType.TIME}>
      ...
      <div class="trip-sort__item  trip-sort__item--offer">
        ...
        value="sort-offer"  data-sort-type="offer" disabled>
